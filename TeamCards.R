...
# Team vectors as defined
TOR<-c(.723,	4.08,	4.14,	12.6,
       .324,	.408,	.321,	76.1,29.8)
BAL<-c(.733,	3.95,	4.07,	15.1,
       .325,	.43,	.328,	114.9,31.8)
TBR<-c(.736,	3.82,	3.89,	16,
       .315,	.398,	.313,49,24.5)
BOS<-c(.714,	4.07,	4,	18.1,
       .326,	.421,	.324,	41.4,22.5)
NYY<-c(.736,	3.88,	4.01,	18,
       .322,	.42,	.323,	81.3,	28.4)
CLE<-c(.727,	4.06,	4.13,	13,
       .32,	.415,	.32,67.5,25.4)
KCR<-c(.72,	4.08,	4.02,	16.8,
       .321,	.424,	.323,	47.2,	24.3)
DET<-c(.726,	3.85,	3.9,	16,
       .311,	.399,	.31,23.2,22.4)
MIN<-c(.728,	3.92,	3.86,	19.5,
       .319,	.413,	.319,	63.5,	24.4)
CHW<-c(.724,	4.51,	4.72,	7.6,
       .305,	.386,	.301,	-40,	14.4)
LAA<-c(.721,	4.36,	4.45,	12.3,
       .318,	.418,	.32,52.4,22.4)
HOU<-c(.728,	4,	4.03,	16.2,
       .325,	.43,	.327,110.7,	29.4)
OAK<-c(.722,	4.14,	4.35,	10.5,
       .308,	.408,	.312,	49.8,	23)
SEA<-c(.737,	3.72,	3.86,	15.7,
       .315,	.391,	.31,59.3,26.1)
TEX<-c(.729,	4.01,	4.05,	15.4,
       .323,	.426,	.325,	82,28.4)
ATL<-c(.734,	3.78,	3.75,	18.9,
       .328,	.444,	.334,99.1,	29.5)
NYM<-c(.735,	3.88,	4.06,	14.4,
       .326,	.426,	.327,	99.6,	30.6)
MIA<-c(.723,	4.06,	4.04,	15.3,
       .312,	.395,	.309,-36.2,	13.9)
PHI<-c(.734,	3.86,	4,	20,
       .326,	.423,	.325,60,23.8)
WSH<-c(.724,	4.23,	4.4,	10.3,
       .311,	.4,	.31,-9.1,	17)
CHC<-c(.73,	4.01,	4.1,	12.8,
       .324,	.41,	.32,	57.8,	25.6)
STL<-c(.724,	3.97,	4.04,	14.6,
       .323,	.408,	.32,46.3,23)
CIN<-c(.719,	4.45,	4.43,	14.6,
       .32,	.419,	.322,	-1.8,	17.9)
PIT<-c(.72,	4.15,	4.1,	15.5,
       .321,	.406,	.317,-7.2, 17.5)
MIL<-c(.734,	3.99,	4.09,	15.4, 
       .318,	.402,	.318, 24.3,	22.7)
ARI=c(.72,	4.07,	3.97,	14.5,
      .332,	.42,	.328,	65.1,	27.5)
SFG<-c(.725,	3.91,	3.9,	12.7, 
       .315,	.408,	.315,	16.9,	24.9)
SDP<-c(.729,	4.06,	4.19,	14.3,
       .322,	.421,	.323,	79,	26.4)
COL<-c(.696,	4.94,	4.69,	8.8,
       .312,	.421,	.318,	-76.3,12.5)
LAD<-c(.739,	3.82,	3.84,	19.9,
       .336,	.439,	.335,128.9,	30.4)
